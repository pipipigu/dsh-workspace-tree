        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              items.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "6px" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontSize: "11px", color: "#64748b" }, children: "\u5FEB\u901F\u586B\u5165\u53C2\u8003\u76EE\u5F55:" }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { display: "flex", flexWrap: "wrap", gap: "6px" }, children: Array.from(
                  new Set(
                    items.map((w) => w.path).filter(Boolean).flatMap((p) => [p, p.split("/").slice(0, -1).join("/") || "/"]).filter((p) => p && p !== "/")
                  )
                ).slice(0, 4).map((p) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                  "button",
                  {
                    style: {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "flex-end", gap: "8px", paddingTop: "6px", borderTop: "1px solid rgba(255, 255, 255, 0.08)" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                  "button",
                  {
                    style: {
